...
const features = [
  ...
  },
  {
    ...
    description: "We present information neutrally — helping you understand, not telling you what to do.",
  },
]
    ...
    <section className="w-full py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Why SemaFy</h2>
          <p className="mt-3 text-muted-foreground max-w-xl mx-auto">Built for informed decisions, not fear</p>
        </div>
